...
<body>
    ...
    <div class="flex flex-col w-full h-fit bg-[#392c43] text-[#e5e7eb] px-14 py-14">
        <div class="flex flex-row">
            <div class="flex flex-col gap-2 justify-center w-[35%]">
                <div class="flex items-center w-full gap-4">
                    <div class="text-5xl">Wiege News</div>
                </div>
            ...
            <div class="flex flex-row w-[45%] justify-end gap-16 text-nowrap">
                    <div class="flex flex-col gap-2">
                        <div class="font-bold uppercase text-[#b2b0a6] pb-3" id="company">Empresa</div>
                        <a href="#" class="hover:underline">Sobre nós</a>
                        <a href="#" id="contact" class="hover:underline">Contato</a>
                        <a href="#" class="hover:underline">Suporte</a>
                        <a href="#" class="hover:underline">Notícias</a>
                    </div>
                    <div class="flex flex-col gap-2">
                        <div class="font-bold uppercase text-[#b2b0a6] pb-3">Legalidade</div>
            ...
            <div class="text-center">© 2025 Wiege News </div>
        </div>
    </div>
</body>
</html>